...
type GlassTypeSectionProps = {
  ...
  onAdd?: () => void;
  onUpdate?: (row: GlassTypeRow) => void;
  onDelete?: (row: GlassTypeRow) => void;
  renderActions?: (row: GlassTypeRow) => ReactNode;
};
...
export function GlassTypeSection({
  ...
  onDelete,
  renderActions,
}: GlassTypeSectionProps) {
  return (
    <SectionCard
      title="Glass Type"
      description="Glass types available for this product."
      rightSlot={
        addTrigger ?? (
          <button
            type="button"
